...
public class signupUsingExcelExtentScreenshot {
	...
	public void setup() throws IOException
	{
		...
		String file = Paths.get(System.getProperty("user.dir") + "./TestReports/extentReport.html").toString();
		spark = new ExtentSparkReporter(file);
		extent.attachReporter(spark);	
		
	}
	@Test(dataProvider = "readLoginData")
	public void validateLogin(String userName, String password, ITestResult result)
	{
	...
	public void validateSignup(String firstName, String lastName, String email, ITestResult result)
	{
