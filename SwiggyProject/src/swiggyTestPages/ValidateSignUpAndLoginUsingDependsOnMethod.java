...
public class ValidateSignUpAndLoginUsingDependsOnMethod {
	WebDriver driver;
	WebDriverWait wait;
	...
	public void validateSingUp(String firstName, String lastName, String email)
	{
	...
	public Object[][] getSignupData() throws IOException 
	{
		...
		Object[][] arr = new Object[rows-1][cols];	Not working
		for(int i=1; i<rows; i++)
		{
			for(int j=0; j<cols; j++)
			{
				...
				{
					arr[i-1][j] = sh.getRow(i).getCell(j);
				}
			}
		}*/
	...
	@Test(dataProvider = "getLoginData", dependsOnMethods = "validateSingUp", enabled = true)
